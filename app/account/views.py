...
import django.contrib.auth.views as contrib_views
...
class Messages:
    ...
    EDIT_SUCCESS = _('Profile updated successfully')
    EDIT_ERROR = _('Error updating your profile')


class EmailLoginView(contrib_views.LoginView):
    """ Display the login form and handle the login action."""
    form_class = forms.CustomAuthenticationForm


class PasswordChangeView(contrib_views.PasswordChangeView):
    form_class = forms.PasswordChangeForm


class PasswordResetView(contrib_views.PasswordResetView):
    form_class = forms.PasswordResetForm


class PasswordResetConfirmView(contrib_views.PasswordResetConfirmView):
